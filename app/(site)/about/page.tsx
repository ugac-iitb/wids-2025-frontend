    ...
    <>
      ...
      <section className="relative py-24 bg-gradient-to-b from-[#0a0a0a] via-[#0f0f1a] to-black overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[-200px] left-[-100px] w-[600px] h-[600px] bg-blue-600/10 blur-2xl rounded-full"></div>
          <div className="absolute bottom-[-200px] right-[-100px] w-[600px] h-[600px] bg-purple-600/10 blur-2xl rounded-full"></div>
        </div>
