...
const ResourceItem = ({ resource }: { resource: Resource }) => {
  ...
  return (
    <motion.a
      ...
      viewport={{ once: true }}
      className="animate_top flex flex-col rounded-lg bg-white shadow-solid-8 dark:bg-blacksection overflow-hidden cursor-pointer transform transition-transform hover:-translate-y-2 hover:shadow-lg"
    >
      {/* IMAGE */}
      ...
      <div className="px-3 py-3 flex-1 flex items-end">
        <h3 className="line-clamp-2 text-base font-semibold text-black dark:text-white transition-colors">
          {resource_name}
        </h3>
      </div>
    </motion.a>
